    ...
    <>
      {synopsisList.length > 0 ? (
        <div className="flex h-[calc(100vh-140px)] flex-col overflow-hidden rounded-sm border md:h-[calc(100vh-200px)] md:flex-row">
          ...
          >
            <div className="sticky top-0 z-10 flex w-full items-center justify-between">
              <button
                onClick={() => setMobileTab("units")}
                className="rounded-lg bg-primary px-3 py-1.5 text-xs text-white transition sm:text-sm md:hidden"
              >
                ← Back to Units
              </button>
